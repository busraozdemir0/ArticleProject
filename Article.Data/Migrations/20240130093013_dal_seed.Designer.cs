...
namespace Article.Data.Migrations
{
    ...
    [Migration("20240130093013_dal_seed")]
    partial class dalseed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Article.Entity.Entities.Articlee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1fea0bce-b9b1-4581-9c89-f606f910b8d6"),
                            ...
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(1056),
                        ...
                        new
                        {
                            Id = new Guid("553bde64-01fd-493e-bfda-e59285b6ff1b"),
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(1066),
            ...
            modelBuilder.Entity("Article.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(3593),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(3599),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Article.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(5768),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 1, 30, 12, 30, 12, 875, DateTimeKind.Local).AddTicks(5773),
